...
\begin{tikzpicture}[scale=1.5]
    ...
    \draw[->,very thick](0,0)--(0.5,0)node[right]{$\hat{\mathbf{n}}$};
    \filldraw[black](0,0)circle(0.5pt);
    \draw[->,very thick](0.9,0)--(1.4,0)node[right]{$\mathbf{J}$};
    \draw[->,very thick](0.5,0.4)--(1.5,0.4)node[midway,above]{$\mathbf{E}$};
