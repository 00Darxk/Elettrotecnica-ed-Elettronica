...
Si applica il secondo teorema di Kirchoff sulle circuitazioni create inserendo una corda alla volta nel grafo albero, di verso concorde alla conrda inserita. Queste 
...
incognita da usare nelle $n-1$ equazioni. Vengono quindi definiti i potenziali modali. Si assegna al nodo non considerato un potenziale nullo. In questo caso $C$. 
Si misurano quindi le tensioni, tenendo il puntale negativo sul nodo $C$. L'equazione risultante si esprime tramite un'altra matrice di incidenza:
\begin{gather*}
    \begin{bmatrix}
        v_1\\
        v_2\\
...
la forma Thevenin estrema. Generalizzando il metodo dei nodi, si può comprendere la forma Thevenin estrema, che non si può esprimere come una forma Northon. 
Questo metodo dei nodi non generalizzato è valido per tutti i circuiti che non contengono forme Thevenin estreme. 

Per cui ogni generico lato corrisponde ad una forma Northon, la sua corrente di lato si può quindi esprimere come:
\begin{equation*}
    i_k=i_{gk}-G_kv_k
\end{equation*}
\begin{center}
...
\begin{equation*}
    \begin{cases}
        ...
        i_3=\displaystyle\frac{10V}{10\,\Omega}-\frac{1}{20\,\Omega}v_3\\
        i_4=\displaystyle-\frac{1}{10\,\Omega}v_4 &i_{g4}=0\\
        i_5=\displaystyle\frac{50V}{10\,\Omega}-\frac{1}{10\,\Omega}v_5\\
        i_6=1\,A &G_6=0\\
        i_7=\displaystyle\frac{1}{5\,\Omega+7\,\Omega}v_7&i_{g7}=0
    \end{cases}
\end{equation*}
Riscrivendole in forma matriciale si ottiene:
\begin{equation*}
    [i_l]=\begin{bmatrix}
        2\,A\\
        \displaystyle-\frac{1}{20\,\Omega}v_2\\
        1\,A-\displaystyle\frac{1}{20\,\Omega}v_3\\
        \displaystyle-\frac{1}{10\,\Omega}v_4\\
        5\,A-\displaystyle\frac{1}{10\,\Omega}v_5\\
        1\,A\\
        \displaystyle\frac{1}{12\,\Omega}v_7
    \end{bmatrix}
\end{equation*}
