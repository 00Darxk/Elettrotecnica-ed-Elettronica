...
\begin{center}
    \begin{tikzpicture}
        ...
        \draw[-](0,0)node[left]{$A$}to[out=45,in=180](3,1)node[above]{$7$}node[below]{$m_4$};
        \draw[<-](3,1)to[out=0,in=135](6,0);
        ...
        \draw[->](3,-1)node[below]{$D$}node[above]{$m_2$}to[out=180,in=330](1,-0.7)node[below left]{$1$}node[right]{$m_1$};
        \draw[-](1,-0.7)to[out=150,in=290](0,0);
...
realizzati. 
%% campo della modellistica circuitale
...
%% cose che ha detto, ma non centrano
