...
\subsubsection{Circuito RLC In Parallelo}

Per la dualità si ottengono delle equazioni delle grandezze duali nel circuito dove i compomenti sono montati in parallelo, applicando il principio di Kirchhoff alle correnti 
invece che alle tensioni. 
...
%% equazioni delle grandezze

\subsection{Generatori Sinusoidali}
...
\begin{center}
    \begin{circuitikz}
        \draw (0,2) to[R=$R$](2,2)
                    ...
                    to[C=$C$](6,2)
                    to[short, i=$i$](6,0)
                    to[european voltage source=$v_g$](0,0) %% generatore sinusoidale
                    to[closing switch](0,2);
    \end{circuitikz}
\end{center}
...
valori di tempo necessariamente elevati. 
...
Si esprimono la corrente a regime e la tensione erogata nel dominio dei fasori:  
\begin{gather*}
...
Si definisce l'ammettenza, il reciproco della resistenza:
\begin{gather*}
...
\begin{center}
    \begin{circuitikz}
        \draw (4,0) to[european voltage source=$E$] (0,0)
...
\begin{gather*}
    ...
    \varphi=\gamma-\beta=0
\end{gather*}
La corrente e la tensione si dicono tra di loro in fase. Gli angoli relativi tra fasori si chiamano sfasamenti. 
\begin{center}
    \begin{tikzpicture}
        \draw[->](0,0)--(2,0)node[right]{$\overline V$};
...
\end{gather*}
Si dice che la tensione è in quadratura in anticipo rispetto alla corrente, analogamente la corrente è in quadratura in ritardo rispetto alla tensione. Il 
...
\begin{gather*}
    ...
    \gamma-\displaystyle\frac{\pi}{2}=\beta\\
    \varphi=\displaystyle\frac{\pi}{2}
\end{gather*}

Si dice che la corrente è in quadratura in anticipo rispetto alla tensione, analogamente la tensione è in quadratura in ritardo rispetto alla corrente.
\begin{center}
    \begin{tikzpicture}
        \draw[->](0,0)--(2,0)node[right]{$\overline V$};
        \draw[->](0,0)--(0,-1)node[right]{$\overline{I}$};
